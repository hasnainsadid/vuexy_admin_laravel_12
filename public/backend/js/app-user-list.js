  ...
  if (
    (a.length &&
      (n = a)
        ...
        .select2({ placeholder: "Select Country", dropdownParent: n.parent() }),
    t)
  ) {
          ...
          render: function (e, t, a, n) {
            ...
            return (
              ...
              ({
                ...
                Author:
                  '<i class="icon-base ti tabler-edit icon-md text-warning me-2"></i>',
                Maintainer:
                  '<i class="icon-base ti tabler-user icon-md text-success me-2"></i>',
                Editor:
                  '<i class="icon-base ti tabler-chart-pie icon-md text-info me-2"></i>',
                Admin:
                          ...
                          body: function (e, t, a) {
                            ...
                            return (
                              0 < r.length
                                ...
                                : (n = e.body.textContent || e.body.innerText),
                              n.trim()
                            );
                          },
                        },
